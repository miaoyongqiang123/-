...
<!--                </div>-->
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="license" style="text-indent: 2em;line-height: 1.5em;height: 500px;overflow: auto;padding: 10px;">
                            ...
                            <p>
                                用户须知：本协议是您与后盾公司之间关于您使用HDCMS产品及服务的法律协议。无论您是个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，包括免除或者限制后盾责任的免责条款及对您的权利限制。请您审阅并接受或不接受本服务条款。如您不同意本服务条款及/或后盾随时对其的修改，您应不使用或主动取消HDCMS产品。否则，您的任何对HDCMS的相关服务的注册、登陆、下载、查看等使用行为将被视为您对本服务条款全部的完全接受，包括接受后盾对服务条款随时所做的任何修改。</p>

                            <p>本服务条款一旦发生变更,
                                后盾将在产品官网上公布修改内容。修改后的服务条款一旦在网站公布即有效代替原来的服务条款。您可随时登陆官网查阅最新版服务条款。如果您选择接受本条款，即表示您同意接受协议各项条件的约束。如果您不同意本服务条款，则不能获得使用本服务的权利。您若有违反本条款规定，后盾公司有权随时中止或终止您对HDCMS产品的使用资格并保留追究相关法律责任的权利。</p>

                            <p>在理解、同意、并遵守本协议的全部条款后，方可开始使用HDCMS产品。您也可能与后盾公司直接签订另一书面协议，以补充或者取代本协议的全部或者任何部分。</p>

                            <p>
                                后盾公司拥有HDCMS的全部知识产权，包括商标和著作权。本软件只供许可协议，并非出售。后盾只允许您在遵守本协议各项条款的情况下复制、下载、安装、使用或者以其他方式受益于本软件的功能或者知识产权。</p>

                            <p>HDCMS遵循Apache Licence2开源协议，并且免费使用（但不包括其衍生产品、插件或者服务）。Apache
                ...
                <a href="{{u('environment')}}" class="btn btn-primary">继续</a>
            </div>
        </div>
    </div>
