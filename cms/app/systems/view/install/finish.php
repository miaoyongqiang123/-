        ...
        <div class="panel-body">
            ...
            <div class="col-xs-9">
                <div class="alert alert-danger text-center">
                    <h1><i class="fa fa-flag"></i> 恭喜你 C89CMS 已经安装成功</h1>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">后台登录帐号</h3>
                    </div>
                    <div class="panel-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" disabled="disabled" value="admin888">
                            </div>
                        </div>
                    </div>
                </div>
                <a href="{{u('admin.login.index')}}" class="btn btn-success btn-block btn-lg">登录系统</a>
            </div>
        </div>
    </div>
